...
```hcl
module "langfuse" {
  source = "github.com/langfuse/langfuse-terraform-gcp?ref=1.0.5"
...
This module version is a **clean Langfuse v4 installation based on v2.1.1 of the Langfuse Helm chart**. It does not migrate existing deployments.
...
| langfuse_chart_version              | Version of the Langfuse Helm chart to deploy                                                                                                                                                              | string       | "2.1.1"                 |    no    |
| app_version                         | Langfuse application version (Docker image tag) to deploy. Defaults to the latest Langfuse release at the time this module version was published.                                                          | string       | "4.38.0"                |    no    |
